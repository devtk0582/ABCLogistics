<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddShippingMethod.ascx.cs"
    Inherits="CMS.UserControls.AddShippingMethod" %>
...
<asp:Panel ID="pnlPopUp" runat="server" CssClass="modalPopup" ScrollBars="Auto">
    <center>
        <asp:UpdatePanel ID="upAddShipMethod" runat="server" UpdateMode="Conditional" Visible="false"
            Width="850px" Height="350px">
            <ContentTemplate>
                <table class="PopupFormBG" width="60%">
                    <tr style="height: 30px;">
                        <td align="left" class="PopupFormTitleStyle">
                            <asp:Label ID="lblTitle" runat="server" Text="Add Shipping Method"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                            <table width="100%" class="tblLabelStyle">
                                ...
                                <tr>
                                    ...
                                    <td style="font-weight: bold;" width="40%" align="left">
                                        <asp:TextBox Columns="30" ID="txtShippingMethodName" TabIndex="1" runat="server"
                                ...
                                <tr>
                                    ...
                                    <td style="font-weight: bold;" align="left">
                                       ...
                                       <%-- <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="Invalid Cost"
