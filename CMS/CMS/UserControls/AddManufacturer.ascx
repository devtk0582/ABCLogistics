<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddManufacturer.ascx.cs" Inherits="CMS.UserControls.AddManufacturer" %>
...
<asp:Panel ID="pnlPopUp" runat="server" CssClass="modalPopup" ScrollBars="Auto">
    <center>
        <asp:UpdatePanel ID="upAddManufacturer" runat="server" Height="350px" 
                    ...
                    <tr style="height: 30px;" class="PopupFormTitleStyle">
                        <td align="left">
                            <asp:Label ID="lblTitle" runat="server" 
                                Text="Add Manufacturer"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
