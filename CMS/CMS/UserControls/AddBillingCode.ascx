<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AddBillingCode.ascx.cs" Inherits="CMS.UserControls.AddBillingCode" %>
...
<asp:Panel ID="pnlPopUp" runat="server" CssClass="modalPopup" ScrollBars="Auto">
    <center>
        <asp:UpdatePanel ID="upAddBillingCode" runat="server" Height="350px" 
                    ...
                    <tr style="height: 30px;" class="PopupFormTitleStyle">
                        <td align="left">
                            <asp:Label ID="lblTitle" runat="server"
                                Text="Add Billing Code"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
                            <table width="100%" class="tblLabelStyle">
                                ...
                                <tr>
                                    ...
                                    <td align="left" style="font-weight: bold;">
                                        <asp:TextBox ID="txtDesc" runat="server" Columns="20" TextMode="MultiLine" Rows="5" CssClass="textbox" 
