<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EditShippingClass.ascx.cs" Inherits="CMS.UserControls.EditShippingClass" %>
...
<asp:Panel ID="pnlPopUp" runat="server" CssClass="modalPopup" ScrollBars="Auto">
    <center>
        <asp:UpdatePanel ID="upEditShippingClass" runat="server" Height="350px" 
            UpdateMode="Conditional" Visible="false" Width="850px">
            <ContentTemplate>
                <asp:HiddenField ID="hfShippingClassID" runat="server" />
                <table class="PopupFormBG" width="60%">
                    <tr style="height: 30px;" class="PopupFormTitleStyle">
                        <td align="left">
                            <asp:Label ID="lblTitle" runat="server"  
                                Text="Edit Shipping Class"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td align="center">
